    ...
    <div className="App dark:bg-white">
      <Router>
        ...
        {/* admin side routing */}
          ...
          <Route exact path="/admin/project/new" element={<AddNewProjectPage  />} />
          <Route path='/admin/project/edit/:id' element = {<UpdateProjectPage />} />
          <Route path='/admin/project/imageupload/:id' element = {<UploadImagePage />} />
          <Route path='/admin/sponsor/imageupload/:id' element = {<UploadSponsorImage />} />
